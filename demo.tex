...
\DeclareFontShape{JY1}{cidj}{m}{1}{<->s * [0.92469] cidjmr1-h}{}
\def\maru2{{\usekanji{JY1}{cidj}{m}{1}\char"E6B4}}
\usepackage{amsmath}
\usepackage{moreverb}
...
\title{\textsf{polycal}パッケージのデモ}\author{tattsan}\date{2014/01/12 v.0.01b}
